...
/* 06/27/2022 - giulianob:
   This file implements this MixFileClass methods.  It should always be
   included AFTER mixfile.h IF AND ONLY IF you need the content of those
   functions in a compilation unit (.cpp).  This is done so that it avoid
   functions to be copy-and-paste repetely on the final ELF file.  */

#ifndef MIXFILE_TAIL_H
#define MIXFILE_TAIL_H

#ifndef MIXFILE_H
#error "mixfile.h should be included before this header file."
#endif
