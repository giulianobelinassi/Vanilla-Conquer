...
{
#if (FRENCH)
    char* repair_shp = "REPAIRF.SHP";
    char* sell_shp = "SELLF.SHP";
    char* map_shp = "MAPF.SHP";
#else
#if (GERMAN)
    char* repair_shp = "REPAIRG.SHP";
    char* sell_shp = "SELLG.SHP";
    char* map_shp = "MAPG.SHP";
#else
    char* repair_shp = "REPAIR.SHP";
    char* sell_shp = "SELL.SHP";
    char* map_shp = "MAP.SHP";
#endif
#endif
