...
void SoundControlsClass::Process(void)
{
    ...
    */
    ...
    ShapeButtonClass stopbtn(BUTTON_STOP, Get_Shape_Pointer(filename), Option_X + Stop_X, Option_Y + Stop_Y);
    ...
    */
    ...
    ShapeButtonClass playbtn(BUTTON_PLAY, Get_Shape_Pointer(filename), Option_X + Play_X, Option_Y + Play_Y);

    /*
    **	Shuffle control.
    */
    TextButtonClass shufflebtn(
        BUTTON_SHUFFLE, TXT_OFF, TPF_6PT_GRAD | TPF_NOSHADOW, Option_X + Shuffle_X, Option_Y + Shuffle_Y, OnOff_Width);

    /*
    **	Repeat control.
    */
    TextButtonClass repeatbtn(
        BUTTON_REPEAT, TXT_OFF, TPF_6PT_GRAD | TPF_NOSHADOW, Option_X + Repeat_X, Option_Y + Repeat_Y, OnOff_Width);
        ...
        if (display) {
            ...
            */
            Fancy_Text_Print(TXT_MUSIC_VOLUME,
                             Option_X + MSlider_X - 5,
                             Option_Y + MSlider_Y - 2,
                             CC_GREEN,
                             TBLACK,
                             TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW | TPF_RIGHT);
            Fancy_Text_Print(TXT_SOUND_VOLUME,
                             Option_X + FXSlider_X - 5,
                             Option_Y + FXSlider_Y - 2,
                             CC_GREEN,
                             TBLACK,
                             TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW | TPF_RIGHT);

            Fancy_Text_Print(TXT_SHUFFLE,
                             Option_X + Shuffle_X - 5,
                             Option_Y + Shuffle_Y + 1,
                             CC_GREEN,
                             TBLACK,
                             TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW | TPF_RIGHT);
