...
bool Init_Game(int, char*[])
{
    ...
    ** Load it first and and find the fonts there. Else, on high resoltuion, use
    ** Windows CCLOCAL.MIX
    */
    ...
    /* Finally, unload MS-DOS LOCAL.MIX and load Windows CCLOCAL.MIX file for the remaining assets. */
    if (local_mix) {
        delete local_mix;
