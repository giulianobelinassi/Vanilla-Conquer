                                ...
                                int multi)
{
    ...
    TextButtonClass varabtn(BUTTON_VAR_A,
                            "A",
    ...
    TextButtonClass varbbtn(BUTTON_VAR_B,
                            "B",
                            TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                            D_VARB_X,
                            D_VARB_Y,
    ...
    TextButtonClass varcbtn(BUTTON_VAR_C,
                            "C",
                            TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                            D_VARC_X,
                            D_VARC_Y,
    ...
    TextButtonClass vardbtn(BUTTON_VAR_D,
                            "D",
                            TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                            D_VARD_X,
                            D_VARD_Y,
    ...
    TextButtonClass varlbtn(BUTTON_VAR_L,
                            "L",
                            TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                            D_VARLOSE_X,
                            D_VARLOSE_Y,
    ...
    TextButtonClass eastbtn(BUTTON_EAST,
                            "East",
                            TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                            D_EAST_X,
                            D_EAST_Y,
    ...
    TextButtonClass westbtn(BUTTON_WEST,
                            "West",
                            TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                            D_WEST_X,
                            D_WEST_Y,
        ...
        if (display) {
            ...
            if (display >= REDRAW_BACKGROUND) {
                ...
                */
                ...
                for (index = D_BORD_X1; index < D_BORD_X2; index += (320 / ICON_PIXEL_W)) {
                    LogicPage->Put_Pixel(index, D_BORD_Y1 - 1, CC_GREEN_SHADOW);
                    LogicPage->Put_Pixel(index, D_BORD_Y2 + 1, CC_GREEN_SHADOW);
                }
                for (index = D_BORD_Y1; index < D_BORD_Y2 - 8; index += (200 / ICON_PIXEL_H)) {
                ...
                */
                ...
                Fancy_Text_Print(
                    "Y", txt_x, txt_y, CC_GREEN, TBLACK, TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW);
...
int MapEditClass::Scenario_Dialog(void)
{
    ...
    */
    ...
    EditClass nodcred(TEDIT_NODCRED,
                      nodcred_buf,
                      8,
                      TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                      D_NODCRED_X,
    ...
    EditClass neutcred(TEDIT_NEUTCRED,
                       neutcred_buf,
                       8,
                       TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                       D_NEUTCRED_X,
    ...
    TextButtonClass gdinbtn(BUTTON_GDI_N,
                            TXT_UP,
                            TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                            D_GDIN_X,
                            D_GDIN_Y,
    ...
    TextButtonClass gdiebtn(BUTTON_GDI_E,
                            TXT_RIGHT,
                            TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                            D_GDIE_X,
                            D_GDIE_Y,
    ...
    TextButtonClass gdisbtn(BUTTON_GDI_S,
                            TXT_DOWN,
                            TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                            D_GDIS_X,
                            D_GDIS_Y,
    ...
    TextButtonClass gdiwbtn(BUTTON_GDI_W,
                            TXT_LEFT,
                            TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                            D_GDIW_X,
                            D_GDIW_Y,
    ...
    TextButtonClass nodnbtn(BUTTON_NOD_N,
                            TXT_UP,
                            TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                            D_NODN_X,
                            D_NODN_Y,
    ...
    TextButtonClass nodebtn(BUTTON_NOD_E,
                            TXT_RIGHT,
                            TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                            D_NODE_X,
                            D_NODE_Y,
    ...
    TextButtonClass nodsbtn(BUTTON_NOD_S,
                            TXT_DOWN,
                            TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                            D_NODS_X,
                            D_NODS_Y,
    ...
    TextButtonClass nodwbtn(BUTTON_NOD_W,
                            TXT_LEFT,
                            TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                            D_NODW_X,
                            D_NODW_Y,
            ...
            if (display >= REDRAW_BACKGROUND) {
                ...
                */
                Fancy_Text_Print("Theater",
                                 D_THEATER_X + D_THEATER_W / 2,
                                 D_THEATER_Y - D_TXT8_H,
                                 CC_GREEN,
                                 TBLACK,
                                 TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW);
...
int MapEditClass::Select_Trigger(void)
{
    ...
    ListClass triggerlist(TRIGGER_LIST,
                          D_LIST_X,
                          D_LIST_Y,
                          D_LIST_W,
                          D_LIST_H,
    ...
    TextButtonClass editbtn(BUTTON_EDIT,
                            "Edit",
                            TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                            D_EDIT_X,
                            D_EDIT_Y,
    ...
    TextButtonClass deletebtn(BUTTON_DELETE,
                              "Delete",
                              TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                              D_DELETE_X,
                              D_DELETE_Y,
...
int MapEditClass::Edit_Trigger(void)
{
    ...
    TextButtonClass teambtn(BUTTON_TEAM,
                            "Team",
                            TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                            D_TEAM_X,
                            D_TEAM_Y,
    ...
    TextButtonClass neutralbtn(BUTTON_NEUTRAL,
                               "Neutral",
                               TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                               D_NEU_X,
                               D_NEU_Y,
    ...
    TextButtonClass multi1btn(BUTTON_MULTI1,
                              "M1",
                              TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                              D_MULTI1_X,
                              D_MULTI1_Y,
    ...
    TextButtonClass multi2btn(BUTTON_MULTI2,
                              "M2",
                              TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                              D_MULTI2_X,
                              D_MULTI2_Y,
    ...
    TextButtonClass multi3btn(BUTTON_MULTI3,
                              "M3",
                              TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                              D_MULTI3_X,
                              D_MULTI3_Y,
    ...
    TextButtonClass multi4btn(BUTTON_MULTI4,
                              "M4",
                              TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                              D_MULTI4_X,
                              D_MULTI4_Y,
    ...
    TextButtonClass volatilebtn(BUTTON_VOLATILE,
                                "Volatile",
                                TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                                D_VOLATILE_X,
                                D_VOLATILE_Y,
    ...
    TextButtonClass persistbtn(BUTTON_PERSIST,
                               "Persistant",
                               TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                               D_PERSIST_X,
                               D_PERSIST_Y,
    ...
    TextButtonClass semipersistbtn(BUTTON_SEMIPERSIST,
                                   "SemiPersistant",
                                   TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                                   D_SEMIPERSIST_X,
                                   D_SEMIPERSIST_Y,
        ...
        if (display) {
            ...
            */
            ...
            if (display >= REDRAW_BACKGROUND) {
                ...
                ....................... Draw the captions .......................
                */
                Fancy_Text_Print("Trigger Editor",
                                 D_DIALOG_CX,
                                 D_DIALOG_Y + D_MARGIN,
                                 CC_GREEN,
                                 TBLACK,
                ...
                Fancy_Text_Print("Events",
                                 D_EVENT_X + D_EVENT_W / 2,
                                 D_EVENT_Y - D_TXT8_H,
                                 CC_GREEN,
                                 TBLACK,
                                 TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW);

                Fancy_Text_Print("Actions",
                                 D_ACTION_X + D_ACTION_W / 2,
                                 D_ACTION_Y - D_TXT8_H,
                                 CC_GREEN,
                                 TBLACK,
                                 TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW);
        ...
        if (display) {
            ...
            */
            ...
            if (display >= REDRAW_BACKGROUND) {
                ...
                ....................... Draw the captions .......................
                */
                Fancy_Text_Print("Import Triggers",
                                 D_DIALOG_CX,
                                 D_DIALOG_Y + D_MARGIN,
                                 CC_GREEN,
                                 TBLACK,
